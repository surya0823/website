...
if($_SERVER['HTTP_HOST'] =='localhost' || $_SERVER['HTTP_HOST'] =='localhost:8888' || $_SERVER['HTTP_HOST'] =='localhost:8080'){
	//Localhost Url
	$config['base_url'] = $root.'/techrefic-new-website/';
}else{		
	//Live Url
...
|
*/
$config['encryption_key'] = 'techrefic786123';
