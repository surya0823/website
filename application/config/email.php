...
$config['smtp_user']        = 'rohan.gour@techrefic.com';
$config['smtp_pass']        = 'Techrefic@2021';
...
// $config['smtp_sasl_auth_enable']    = yes;                       // DKIM Identity, usually the email address used as the source of the email.